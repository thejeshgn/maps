...
L.Control.Button = L.Control.extend({
  ...
  _makeButton: function (button) {
    var newButton = L.DomUtil.create('div', 'leaflet-bar leaflet-buttons-control-button home_button ', this._container);
    if(button.toggleStatus)
    	L.DomUtil.addClass(newButton,'leaflet-buttons-control-toggleon');
        
    var image = L.DomUtil.create('img', 'leaflet-buttons-control-img home_button_img', newButton);
